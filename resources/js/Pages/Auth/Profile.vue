                ...
                <div class="md:flex-1">
                    <form @submit.prevent="submit">
                        ...
                        <div class="mt-4">
                            ...
                            <BreezeInput id="email" type="email" class="block mt-1 w-full" v-model="form.email"
                                required />
                        </div>

                        <div class="mt-4">
                            <BreezeLabel for="password" value="New password" />
                            <BreezeInput id="password" type="password" class="block mt-1 w-full"
                        ...
                        <BreezeButton class="block mt-4 " :class="{ 'opacity-25': form.processing }"
