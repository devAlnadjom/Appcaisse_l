<template>
    <header class="z-10 py-4 bg-white shadow-md">
      <div class="container flex justify-between items-center px-6 mx-auto h-full text-purple-600 md:justify-end">
        ...
        <BreezeDropdown>
          <template #trigger>
            <button class="align-middle flex rounded-full focus:shadow-outline-purple focus:outline-none p-1 hover:bg-indigo-100" aria-label="Account" aria-haspopup="true">
                <span class="mr-1">
